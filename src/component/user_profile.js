                   ...
                   <MDBRow className='user_container'>
                       ...
                       <MDBRow>
                           ...
                           <div className='user3'>New Company name</div>
                               <div className='user3'>Satmasjid Road, Mohammadpur, Dhaka 1207</div>
                   ...
                   <MDBRow >
                        <MDBCol md="3" className='user_container'>
                            ...
                            <MDBRow>
                                ...
                                <MDBCol md="8">
                                    <MDBBtn className='user_disconnected_btn'>Disconnected</MDBBtn>
                                </MDBCol>
                            </MDBRow>
                            ...
                            <div id='user11'>
                            By clicking any on this social icon you will directly redirect to his/her social Profile
                            </div>
                        </MDBCol>
                        
                   <MDBCol md="8" className='user_container offset-sm-1'  > 
                     <MDBRow>
                         <MDBCol md="3" id='user7'>Subscription</MDBCol>
                         <MDBCol md="6" className='user12'>Premium Monthly</MDBCol>
                         <MDBCol md="3">
                     ...
                     <MDBRow>
                        <MDBCol md="5"><img src={mastercard}  /> </MDBCol>
                        <MDBCol md="5"><img src={paypal}  /></MDBCol>
                        <MDBCol md="2" ><MDBBtn id='add_more'>+</MDBBtn></MDBCol>
                    </MDBRow>
                   </MDBCol>
                   </MDBRow>
